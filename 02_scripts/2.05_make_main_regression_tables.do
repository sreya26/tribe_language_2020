...
*********************************************************************************************************************
		...
		foreach dtype of local dist_types {
			foreach type of local match_to {
				...
				esttab LITERACY_Y61 PRIMARYPLUS_Y61 MIDDLEPLUS_Y61 MATRICPLUS_Y61 GRADUATE_Y61
					using "../04_results/01_tables/5_regression_`type'_`dtype'_`area'.tex", replace
					booktabs
	...
	project , creates("../04_results/01_tables/5_regression_dominant_f8_all.tex")
	project , creates("../04_results/01_tables/5_regression_dominant_f8_protected.tex")
	project , creates("../04_results/01_tables/5_regression_dominant_f8_unprotected.tex")
