...
************************************************************************************************************************
	...
	replace min_str = string(round(min,0.001)) if variables == "st_frac" | strpos(variables,"_rate_")
	replace max_str = string(round(max,0.001))  if variables == "st_frac" | strpos(variables,"_rate_")
	replace max_str = string(round(max,0.1))  if strpos(variables, "wt_lang_dist_")
	replace p50_str = string(round(p50,0.001))  if variables == "st_frac" | strpos(variables,"_rate_")
	...
	replace mean_str = string(round(mean,0.001))  if variables == "st_frac" | strpos(variables,"_rate_")
	replace sd_str = string(round(sd),"%13.0gc")  if variables == "total_p_2011"
	replace sd_str = string(round(sd,0.001))  if variables == "st_frac" | strpos(variables,"_rate_")
