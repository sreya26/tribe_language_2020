...
*********************************************************************************************************
* this file differs from 3.02_subsi_descriptive_stats.do in two respects:
* 1. it makes tables for the Fifth and Sixth Schedule areas rather than the entire country
* 2. it utilizes various measures of linguistic distance
********************************************************************************************************
...
*	rename lang_distance_f8_dominant linguistic_distance
	...
	********************************************************************************************************
	...
	listtab castegroup_1961_2011_code india_tribe_perc l1 s1 
		...
		using "../04_results/01_tables/3_new_summary_table_2a.tex", replace
		rstyle(tabular)
		head(
		`"\toprule"'
...
********************************************************************************************************
	...
	********************************************************************************************************
	...
	listtab state_1961 tribal_pop_perc dominant_language 
		...
		using "../04_results/01_tables/3_new_summary_table_1a.tex", replace
		rstyle(tabular)
		head(
		`"\toprule"'
...
*	rename lang_distance_f8_dominant linguistic_distance
	...
	* drop small states ( < 5 million in census 2011) and those with a small ST population ( < 1% of state population)
	...
	#delimit ;
	listtab 
		using "../04_results/01_tables/3_new_summary_table_3a.tex", replace
		rstyle(tabular)
		head(
		`"\toprule"'
